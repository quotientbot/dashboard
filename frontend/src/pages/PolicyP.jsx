      ...
      <Inner>
        ...
        <div className='flex-grow overflow-y-auto'>
          <div className='h-auto w-[80vw] ml-[10vw] lg:mt-[15vh] mt-4 lg:text-2xl cursor-default text-xl text-justify'>
            <h1 className='text-4xl font-bold tracking-wide text-center mb-8'>Privacy Policy</h1>
            <div className="pl-5 my-8">
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' style={{ textAlign: 'left' }}>Definitions</h1>
              <h4 style={{ textAlign: 'left' }}>Service</h4>
              ...
              <h4 style={{ textAlign: 'left' }}>Usage Data</h4>
              <ul style={{ textAlign: 'left' }}>
              ...
              <h4 style={{ textAlign: 'left' }}>Data Controller</h4>
              <ul style={{ textAlign: 'left' }}>
              ...
              <h4 style={{ textAlign: 'left' }}>Data Processors (or Service Providers)</h4>
              <ul style={{ textAlign: 'left' }}>
              ...
              <h4 style={{ textAlign: 'left' }}>Data Subject (or User)</h4>
              <ul style={{ textAlign: 'left' }}>
                <li>Data Subject is any living individual who is using our Service and is the subject of Personal Data.</li>
              </ul>


              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' style={{ textAlign: 'left' }}>Information Collection and Use</h1>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' style={{ textAlign: 'left' }}>Personal Data</h1>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Tracking & Cookies</h1>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Tracking & Cookies Data</h1>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Use of Data</h1>
              <p>Quotient HQ uses the collected data for various purposes:</p>
              <ul>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Legal Basis for Processing Personal Data under the General Data Protection Regulation (GDPR)</h1>
              ...
              <p>Quotient HQ may process your Personal Data because:</p>
              <ul>
              ...
              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Retention of Data</h1>
              <p>Quotient HQ will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
              <p>Quotient HQ will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>


              <h1 className='text-4xl font-bold tracking-wide text-center mb-8' >Transfer of Data</h1>
...
<p>Quotient HQ may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
  <li>To comply with a legal obligation</li>
  <li>To protect and defend the rights or property of Quotient HQ</li>
...
<p>Our Policy on "Do Not Track" Signals under the California Online Protection Act (CalOPPA):</p>
...
<p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Quotient HQ aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
...
<ul>
  <li>The right to access, update or delete the information we have on you. Whenever possible, you can access, update or request deletion of your Personal Data directly within your account settings section. If you are unable to perform these actions yourself, please contact us to assist you.</li>
  ...
  <li>The right to withdraw consent. You also have the right to withdraw your consent at any time where Quotient HQ relied on your consent to process your personal information.</li>
</ul>
...
<h1>Google AdSense & DoubleClick Cookie</h1>
...
<h1 style={{ textAlign: 'left' }}>Payments</h1>
...
<h1 style={{ textAlign: 'left' }}>Links to Other Sites</h1>
...
<h1 style={{ textAlign: 'left' }}>Children's Privacy</h1>
...
<h1 style={{ textAlign: 'left' }}>Changes to This Privacy Policy</h1>
